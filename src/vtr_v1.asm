...
loc_10A1:
		LDA	byte_1728,Y	; sequence array lsb
		STA	$FA
		LDA	byte_16EA,Y	; sequence array msb
		STA	$FB
		LDY	unk_1081,X
		LDA	($FA),Y
		BMI	loc_10D2
...
byte_1498:
		.BYTE	$69,$BF,$CC,$DC,$E3,$ED,$F7,  1, $B,$15,$25,$35,$3F,$4F,$59,$66 ; arpeggio array lsb

byte_14A8:
		.BYTE	$E0,$14,$14,$14,$14,$14,$14,$15,$15,$15,$15,$15,$15,$15,$15,$15 ; arpeggio array msb
		.BYTE	$22

unk_14B9:
		.BYTE	$67	; track	order lsb
		.BYTE	$6A
		.BYTE	$6D
...
byte_1728:
		.BYTE	$70,$72,$74,$76,$78,$7A,$7C,$7E,$80,$82,$84,$86,$88,$8A,$8C,$8E ;	sequence array lsb
		.BYTE	$90,$92,$94,$96,$98,$9A,$9C,$9E,$A0,$A2,$A4,$A6,$A8,$AA,$AC,$AE
		.BYTE	$B0,$B2,$B4,$B6,$B8,$BA,$BC,$BE,$C0,$C2,$C4,$C6,$C8,$CA,$CC,$CE
		.BYTE	$D0,$D2,$D4,$D6,$D8,$DA,$DC,$DE,$E0,$E2,$E4,$E6,$E8,  0
